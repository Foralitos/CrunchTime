        ...
        public void SaveCurrentState(bool saveAsOpen)
{
    if (saveAsOpen)
    {
        ...
        Debug.Log("Position Saved Open, Position: " + openedPosition + ", Rotation: "+ openedRotation);
    }
    else
    {
        closedRotation = transform.localEulerAngles;
        closedPosition = transform.localPosition;
        Debug.Log("Position Saved Closed: Position: " + closedPosition + ", Rotation:" + closedRotation);
    }
}
